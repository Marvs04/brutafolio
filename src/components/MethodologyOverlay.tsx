...
export const MethodologyOverlay: React.FC = () => {
  ...
  const steps = [
    { icon: GitBranch, title: t.methodologyStep1Title, desc: t.methodologyStep1Desc },
    { icon: Layers, title: t.methodologyStep2Title, desc: t.methodologyStep2Desc },
    { icon: Activity, title: t.methodologyStep3Title, desc: t.methodologyStep3Desc },
    { icon: Database, title: t.methodologyStep4Title, desc: t.methodologyStep4Desc },
  ];
  ...
  return (
    <div className="space-y-16" data-blueprint="organism:methodology-panel" data-blueprint-id="methodology-panel" data-blueprint-logic="Rendered inside DUCPage accordion — showMethodology state">
      <header>
        ...
        <h2 className="font-mono font-bold tracking-tighter uppercase text-2xl md:text-3xl lg:text-5xl">
